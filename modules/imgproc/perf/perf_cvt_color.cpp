...
typedef std::tr1::tuple<Size, CvtMode16u32f> Size_CvtMode16u32f_t;
typedef perf::TestBaseWithParam<Size_CvtMode16u32f_t> Size_CvtMode16u32f;

PERF_TEST_P(Size_CvtMode16u32f, cvtColor32f,
            testing::Combine(
...
PERF_TEST_P(Size_CvtMode16u32f, cvtColor16u,
            testing::Combine(
                testing::Values(::perf::szODD, ::perf::szVGA, ::perf::sz1080p),
                CvtMode16u32f::all()
                )
